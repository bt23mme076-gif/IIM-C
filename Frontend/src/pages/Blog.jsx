...
if (typeof document !== 'undefined') {
  ...
  if (!document.getElementById('bl-styles')) {
    ...
    _blStyle.textContent = `
      ...
      .bl-hero{background:linear-gradient(135deg,#f0f0f0 0%,#f9f9f9 100%);padding:80px 24px 64px;border-bottom:1px solid rgba(0,75,141,.12);position:relative;overflow:hidden;}
      ...
      .bl-accent-bar{width:80px;height:4px;background:#333333;border-radius:2px;margin:0 auto 28px;}
      ...
      .bl-stat strong{font-family:'Playfair Display',serif;font-size:1.8rem;font-weight:700;color:#1a1a1a;}
      ...
      .bl-search-inp:focus{border-color:#1a1a1a;}
      ...
      .bl-cat-tag{display:inline-block;font-family:'Inter',sans-serif;font-size:.68rem;font-weight:600;letter-spacing:.12em;text-transform:uppercase;color:#333333;background:#f9f9f9;padding:3px 10px;border-radius:2px;border:1px solid rgba(0,0,0,0.12);}
      ...
      .bl-title-link:hover{color:#1a1a1a;}
      .bl-excerpt-wrap{border-left:3px solid #333333;padding-left:16px;margin-bottom:20px;}
      ...
      .bl-divider{width:36px;height:2px;background:#333333;margin-bottom:20px;border-radius:1px;}
      .bl-read-btn{display:inline-flex;align-items:center;gap:7px;font-family:'Inter',sans-serif;font-size:.8rem;font-weight:600;letter-spacing:.04em;text-transform:uppercase;color:#1a1a1a;background:transparent;border:2px solid #1a1a1a;padding:9px 18px;border-radius:6px;cursor:pointer;transition:background .2s,color .2s,transform .15s;text-decoration:none;}
      .bl-read-btn:hover{background:#1a1a1a;color:white;transform:translateY(-1px);}
      ...
      .bl-expand-inner{background:#f5f5f5;border-radius:8px;padding:20px 22px;margin-top:16px;font-family:'Inter',sans-serif;font-size:.9rem;color:#374151;line-height:1.75;border-left:3px solid #1a1a1a;}
      ...
      .bl-month-btn:hover{background:#f5f5f5;color:#1a1a1a;}
      .bl-month-btn.active{font-weight:600;color:#1a1a1a;background:#f0f0f0;}
                ...
                <article key={blog.id} className="py-10 border-b border-gray-200 last:border-b-0">
                  ...
                  <div className="flex flex-col sm:flex-row gap-8 items-start">
                    ...
                    <div className="flex-1 min-w-0">
                      <blockquote className="border-l-4 border-[#1a1a1a] pl-4 mb-5">
                      ...
                      <button
                        className={`inline-flex items-center gap-2 font-['Inter'] font-bold text-sm text-[#1a1a1a] group focus:outline-none ${openBlogId === blog.id ? 'underline' : ''}`}
                      ...
                      >
                        {openBlogId === blog.id && (
                          <div className="bg-[#f5f5f5] rounded-lg p-5 text-gray-700 font-['Inter'] text-base shadow-sm">
                            {isAdmin ? (
                              <EditableText
                                collection="blogs"
                                docId={blog.id}
                    ...
                    <li key={month}>
                      <button
                        ...
                        className={`w-full text-left text-sm font-['Inter'] py-1.5 px-2 transition-colors ${
                          activeMonth === month
                            ? 'font-bold text-[#1a1a1a] bg-[#f5f5f5]'
