...
if (typeof document !== 'undefined' && !document.getElementById('bp-styles')) {
  ...
  style.textContent = `
    ...
    .bp-cat { font-family:'Inter',sans-serif; font-size:.68rem; font-weight:600; letter-spacing:.12em; text-transform:uppercase; color:#333333; background:#fff7ed; padding:3px 10px; border-radius:2px; border:1px solid rgba(249,115,22,.25); }
    ...
    .bp-excerpt { font-family:'Playfair Display',Georgia,serif; font-style:italic; font-size:1.1rem; color:#6b7280; line-height:1.75; border-left:3px solid #333333; padding-left:18px; margin:0; }
    ...
    .bp-avatar { width:40px; height:40px; border-radius:50%; background:#1a1a1a; color:white; display:flex; align-items:center; justify-content:center; font-family:'Playfair Display',serif; font-size:1.1rem; font-weight:700; flex-shrink:0; }
    ...
    .bp-textarea:focus { border-color:#1a1a1a; }
    .bp-submit { display:inline-flex; align-items:center; gap:8px; background:#1a1a1a; color:white; font-family:'Inter',sans-serif; font-size:.85rem; font-weight:600; letter-spacing:.04em; text-transform:uppercase; padding:12px 28px; border:none; border-radius:6px; cursor:pointer; transition:background .2s; align-self:flex-start; }
    .bp-submit:hover:not(:disabled) { background:#000000; }
    ...
    return (
      <div className="bp-loading">
        <div style={{ textAlign: 'center' }}>
          <div style={{ width: 48, height: 48, border: '3px solid #e5e7eb', borderTopColor: '#1a1a1a', borderRadius: '50%', animation: 'spin 0.8s linear infinite', margin: '0 auto 16px' }} />
  ...
  if (!blog) {
    return (
      <div className="bp-not-found">
        ...
        <Link to="/blog" style={{ display: 'inline-flex', alignItems: 'center', gap: 6, background: '#1a1a1a', color: 'white', padding: '10px 22px', borderRadius: 6, textDecoration: 'none', fontFamily: 'Inter, sans-serif', fontWeight: 600, fontSize: '0.875rem' }}>
